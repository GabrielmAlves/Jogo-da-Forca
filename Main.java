...
public class Main
{
	public static void main (String args [])
    {
        ...
        {
			Palavra palavra =
			BancoDePalavras.getPalavraSorteada(); //testado e funcionando

			Tracinhos tracinhos = null; 
			try
			{
			    tracinhos = new Tracinhos (palavra.getTamanho()); //testado e funcionando
            }
			...
			try
			{
			    controladorDeErros = new ControladorDeErros ((int)(palavra.getTamanho()*0.6)); //testado e funcionando
			}
			catch (Exception erro)
			{}
			...
			{
				System.out.println ("Palavra...: "+tracinhos); //colocar a string to string para retornar com a separacao
				System.out.println ("Digitadas.: "+controladorDeLetrasJaDigitadas); // testado e funcionando
				System.out.println ("Erros.....: "+controladorDeErros); //testado e funcionando
